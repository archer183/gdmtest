...
int16_t applyCurve(int16_t x, int8_t idx)
{
  /* already tried to have only one return at the end */
	uint8_t scp[65] = {255,255,255,254,254,253,252,
	251,250,249,247,246,244,242,240,238,236,233,231,
	228,225,222,219,215,212,208,205,201,197,193,189,
	185,180,176,171,167,162,157,152,147,142,136,131,
	,126,120,115,109,103,98,92,86,80,74,68,62,56,50,
	44,37,31,25,19,13,6,0}/*100,100,100,100,100,99,99,99,
